...
for n in range(3):
    ...
    for m in url1:
        geturl2(str(m))
    os.mkdir('/home/wuyuze/python-1/theme'+str(n))
    os.chdir('/home/wuyuze/python-1/theme'+str(n))
    for m in range(100):
        print url2[m]
        content=Getcontent()
        content.mark=m+1
        htmlcontent=urllib.urlopen(str(url2[m])).read()
